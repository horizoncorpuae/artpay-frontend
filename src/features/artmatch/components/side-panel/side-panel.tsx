...
const SidePanel = () => {
  ...
  return (
    <aside className={"h-screen rounded-r-2xl w-full max-w-xs lg:max-w-sm bg-white pt-38 lg:pt-30 px-6"}>
      <Button className={"custom-navbar flex items-center gap-2.5 py-6!"}>
        <FilterIcon />
