  ...
  return (
    <section className={'max-w-xl'}>
      <section className={"leading-[105%] space-y-9 mb-12"}>
        ...
        <h2 className={"font-bold text-3xl text-balance"}>Offri ai tuoi clienti l’arte che desiderano, in comode rate</h2>
        <p className={"text-lg"}>
      ...
      <section>
        ...
        <ul className={"ps-4 text-lg space-y-4"}>
          <li
            className={
              'before:text-[#6576EE] before:content-["•"] relative before:absolute before:top-1/2 before:-left-4 before:-translate-y-1/2 before:text-2xl ps-4 leading-[115%]'
            }>
